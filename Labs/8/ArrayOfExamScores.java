...
public class ArrayOfExamScores {
    ...
    public static void main(String[] args) {
        ...
        int numStudentsInClass = consoleInput.nextInt();
        ...
        double avgScore = (double)runningTotal/numStudentsInClass;
        ...
        System.out.println("The highest score is student " + maximumScoreStudent + " with a score of " + maximumScore + ".");
    }
}
